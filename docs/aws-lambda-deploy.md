...
![specify your domain name](/img/docs/cert/request-cert-step-1.png)

### Step 4: Choose DNS validation

![choose dns validation](/img/docs/cert/request-cert-step-2.png)

### Step 5: Add tags (optional)

![optionally add tags](/img/docs/cert/request-cert-step-3.png)

### Step 5: Review

![review](/img/docs/cert/request-cert-step-4.png)
...
![pending validation](/img/docs/cert/request-cert-step-5.png)
...
![add a cname](/img/docs/cert/request-cert-step-6.png)
...
![issued](/img/docs/cert/request-cert-step-7.png)

### Step 8: Copy the certificate ARN (Amazon Resource Name) for use with this CloudFormation stack

![certificate arn](/img/docs/cert/request-cert-step-8.png)
...
![stack outputs](/img/docs/nameservers/stack-outputs.png)
...
![hosted zones](/img/docs/nameservers/hosted-zone-list.png)

### Step 2: Find the nameservers

Click on the hosted zone to display the nameservers you need to use with your registrar:

![hosted zone nameservers](/img/docs/nameservers/hosted-zone-nameservers.png)
...
![registrar nameservers](/img/docs/nameservers/registrar-nameservers.png)
...
![update button](/img/docs/upgrade/update-button.png)

![update button](/img/docs/upgrade/update-form.png)
